...
---
[![DEMO]([https://img.youtube.com/vi/watch?v=ctjIoP2XZ-M/0](https://youtu.be/ctjIoP2XZ-M?si=QqE80YX1RStNRiSV)/0.jpg)]([https://www.youtube.com/watch?v=视频ID](https://youtu.be/ctjIoP2XZ-M?si=QqE80YX1RStNRiSV))
...
- **FilePicker integration** for choosing export folder

### ⌨️ Keyboard Shortcuts

| Shortcut | Action |
|----------|--------|
| `Space` | Quick toggle Move tool |
| `Ctrl+Z` / `Ctrl+Y` | Undo / Redo |
| `Delete` | Delete selection |
| `[ / ]` | Decrease / Increase brush size |
| `Alt+Scroll` | Adjust tolerance or brush size |
| `Shift+Scroll` | Scale character art (Move tool) |
...
2. Paste the manifest URL:
   ```
   https://github.com/SORA-dnd/silhouette/releases/latest/download/module.json
   ```
3. Click **Install**

### Method 2: Manual
1. Download the latest `silhouette.zip` from [Releases](https://github.com/SORA-dnd/silhouette/releases)
2. Extract to `Data/modules/`
...
6. Pick a **Token Ring** preset
7. Use **Move / Scale** (`Space` to quick-toggle, `Shift+Scroll` to resize)
8. Paint **Overflow** areas for pop-out effects
9. Choose resolution and click **Export PNG**
...
[![Patreon](https://img.shields.io/badge/Patreon-Support%20Me-ff424d?style=for-the-badge&logo=patreon&logoColor=white)](https://www.patreon.com/Reslinfvtt)
